...
import { ModelInfo } from '@/simulation/types';
...
interface Props {
  ...
  disabled: boolean; // 시뮬레이션 진행 중이면 모델 변경 불가
}
  ...
  return (
    <div className="bg-gray-900 border border-gray-700 rounded-xl p-4 space-y-4">
      ...
      <div>
        ...
        {disabled && (
          <p className="text-[10px] text-gray-600 mt-1">시뮬레이션 중에는 모델 변경이 불가합니다. 리셋 후 변경하세요.</p>
        )}
      </div>
